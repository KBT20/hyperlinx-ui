...
const LAYER_STYLES: Record<MapLayerId, MapPrimitiveStyle> = {
  ...
  inventory: { stroke: "#64748b", fill: "#475569", strokeWidth: 2, radius: 3, opacity: 0.75 },
  ...
  site: { stroke: "#be123c", fill: "#e11d48", strokeWidth: 2, radius: 6, opacity: 0.95 },
  attachment: { stroke: "#0369a1", fill: "#0ea5e9", strokeWidth: 2, radius: 5, opacity: 0.95 },
  lateral: { stroke: "#dc2626", fill: "none", strokeWidth: 3, opacity: 0.9, dasharray: "8 6" },
};
